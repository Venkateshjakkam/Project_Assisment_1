      ...
      <div className="main_container2">
        ...
        <div>
          <h1 className="main_text">
            ...
            <br></br>learning platform
          </h1>
          <br></br>
          <pre>
            <p>After years of research and experience we have come up with a</p>
            <p>
              curriculum which will not only help you to build the foundation
              very
            </p>
          ...
          <pre>
            ...
            <p>
              your job when you face your first interview. Best in class
              Academic
            </p>
            <p>
          ...
          <br></br>
          <br></br>
          <button className="modleButton" onClick={openModal} >
            Contact Us
          </button>
